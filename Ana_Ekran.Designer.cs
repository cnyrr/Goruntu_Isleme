namespace Görüntü_İşleme
{
    partial class Ana_Ekran
    {
        ...
        {
            HaftaBirButonu = new Button();
            HaftaIkiButonu = new Button();
            HaftaBesButonu = new Button();
            HaftaAltiButonu = new Button();
            HaftaUcButonu = new Button();
            ...
            // HaftaBirButonu
            // 
            HaftaBirButonu.Location = new Point(12, 12);
            HaftaBirButonu.Name = "HaftaBirButonu";
            HaftaBirButonu.Size = new Size(128, 64);
            HaftaBirButonu.TabIndex = 0;
            HaftaBirButonu.Text = "1. Hafta";
            HaftaBirButonu.UseVisualStyleBackColor = true;
            HaftaBirButonu.Click += HaftaBirButonu_Click;
            // 
            // HaftaIkiButonu
            // 
            HaftaIkiButonu.Location = new Point(12, 82);
            HaftaIkiButonu.Name = "HaftaIkiButonu";
            HaftaIkiButonu.Size = new Size(128, 64);
            HaftaIkiButonu.TabIndex = 1;
            HaftaIkiButonu.Text = "2. Hafta";
            HaftaIkiButonu.UseVisualStyleBackColor = true;
            HaftaIkiButonu.Click += HaftaIkiButonu_Click;
            // 
            // HaftaBesButonu
            // 
            HaftaBesButonu.Location = new Point(280, 12);
            HaftaBesButonu.Name = "HaftaBesButonu";
            HaftaBesButonu.Size = new Size(128, 64);
            HaftaBesButonu.TabIndex = 2;
            HaftaBesButonu.Text = "5. Hafta";
            HaftaBesButonu.UseVisualStyleBackColor = true;
            HaftaBesButonu.Click += HaftaBesButonu_Click;
            // 
            // HaftaAltiButonu
            // 
            HaftaAltiButonu.Location = new Point(280, 82);
            HaftaAltiButonu.Name = "HaftaAltiButonu";
            HaftaAltiButonu.Size = new Size(128, 64);
            HaftaAltiButonu.TabIndex = 3;
            HaftaAltiButonu.Text = "6. Hafta";
            HaftaAltiButonu.UseVisualStyleBackColor = true;
            HaftaAltiButonu.Click += HaftaAltiButonu_Click;
            // 
            // HaftaUcButonu
            // 
            HaftaUcButonu.Location = new Point(12, 152);
            HaftaUcButonu.Name = "HaftaUcButonu";
            HaftaUcButonu.Size = new Size(128, 64);
            HaftaUcButonu.TabIndex = 4;
            HaftaUcButonu.Text = "3. Hafta";
            HaftaUcButonu.UseVisualStyleBackColor = true;
            HaftaUcButonu.Click += HaftaUcButonu_Click;
            // 
            // HaftaYediButonu
            // 
            HaftaYediButonu.Location = new Point(280, 152);
            HaftaYediButonu.Name = "HaftaYediButonu";
            HaftaYediButonu.Size = new Size(128, 64);
            HaftaYediButonu.TabIndex = 5;
            HaftaYediButonu.Text = "7. Hafta";
            HaftaYediButonu.UseVisualStyleBackColor = true;
            HaftaYediButonu.Click += HaftaYediButonu_Click;
            // 
            // HaftaSekizButonu
            // 
            HaftaSekizButonu.Location = new Point(280, 222);
            HaftaSekizButonu.Name = "HaftaSekizButonu";
            HaftaSekizButonu.Size = new Size(128, 64);
            HaftaSekizButonu.TabIndex = 7;
            HaftaSekizButonu.Text = "8. Hafta";
            HaftaSekizButonu.UseVisualStyleBackColor = true;
            HaftaSekizButonu.Click += HaftaSekizButonu_Click;
            // 
            // HaftaDortButonu
            // 
            HaftaDortButonu.Location = new Point(12, 222);
            HaftaDortButonu.Name = "HaftaDortButonu";
            HaftaDortButonu.Size = new Size(128, 64);
            HaftaDortButonu.TabIndex = 8;
            HaftaDortButonu.Text = "4. Hafta";
            HaftaDortButonu.UseVisualStyleBackColor = true;
            HaftaDortButonu.Click += HaftaDortButonu_Click;
            // 
            // HaftaDokuzButonu
            // 
            HaftaDokuzButonu.Location = new Point(548, 12);
            ...
            Controls.Add(HaftaUcButonu);
            Controls.Add(HaftaAltiButonu);
            Controls.Add(HaftaBesButonu);
        ...
        private Button HaftaBirButonu;
        private Button HaftaIkiButonu;
        private Button HaftaBesButonu;
        private Button HaftaAltiButonu;
        private Button HaftaUcButonu;
